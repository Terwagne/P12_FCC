...
witchLocation()
    ...
    region = MKCoordinateRegion(center: cinetoileMap, latitudinalMeters: 1000, longitudinalMeters: 1000)
    ...
    region = MKCoordinateRegion(center: canettoilesMap, latitudinalMeters: 1000, longitudinalMeters: 1000)
